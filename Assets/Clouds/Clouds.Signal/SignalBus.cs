...
#if UNITY_EDITOR
        // Plain Dictionaries don't self-heal like UnityEngine.Object references do, so stale subscribers
        // would otherwise leak across Play sessions when domain reload is disabled.
